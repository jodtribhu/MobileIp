...
public class Mobile_node_home_domain {
	public static void main(String args[]) throws Exception
	   {
		System.out.println("Mobile Node In Home Domain");
	     ...
	     { 
	      ...
	      System.out.println("Sequence Number (Mobile Node in home domain): "+i+" Time: "+new SimpleDateFormat("HH:mm:ss").format(Calendar.getInstance().getTime())+ " Dest ="+ homehost.getHostAddress()+"/"+homeagentport);
	      Thread.sleep(1000);
